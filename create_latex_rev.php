...
$myfile = fopen("dic_".$dic_name."_rev.tex", "w") or die("Unable to open file!");
...
try {
    ...
    $result4 = $link->query("SELECT * FROM alpha_order_target ORDER BY glyph_order");
...
try {
    ...
    $result5 = $link->query("SELECT * FROM glosses WHERE LEFT (gloss, 1) IN ($glyphs_in) ORDER BY gloss COLLATE utf8mb4_general_ci");
...
\\begin{multicols}{2}";
      ...
      foreach ($result5 as $key => $row){
        ...
        try {
            ...
            $result6 = $link->query("SELECT * FROM sense_bundles WHERE sense_bundle_id = '$sense_bundle_id'");
